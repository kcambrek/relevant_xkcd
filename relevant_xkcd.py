...
st.write("For everything is a relevant xkcd comic. The problem is finding the most relevant one. This is a simple app which does that for you based on your query.")
